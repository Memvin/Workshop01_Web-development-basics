...
**Requirements**
- Add HTML5 document structure (doctype, html, head, body)
- Add a <title> in the head
- In the body include:
  - <h1> with your name or site title
  - <h2> with a short tagline
  - A paragraph introducing yourself
  - An image (<img>) using the provided assets or a placeholder
...
- Add corresponding section elements with matching IDs
- In CSS:
...
- Include:
  - Text input for name with a <label>
  - Email input for email with a <label>
  - Textarea for message with a <label>
  - Submit button
...
- Ensure labels use `for` attributes for accessibility
...
**Requirements**
- Add viewport meta tag to head if missing:
